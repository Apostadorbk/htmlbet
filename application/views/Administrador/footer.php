		...
		<!-- App -->
		<script type="text/javascript" src="<?php echo base_url('assets/admin/app/js/app.js') ?>"></script>
		...
		<!-- Value ou Constant -->
		<script type="text/javascript" src="<?php echo base_url('assets/admin/app/js/value/adminConfig.js') ?>"></script>
