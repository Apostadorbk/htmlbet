<div class="wrapper">
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li>
                    <a href="" ng-click="selectItem('teste', 'Teste', 'Descrição do teste')">
                        <i class="fa fa-link"></i> 
                        <span>Teste</span>
                    </a>
                </li>
                ...
                <li>
                    <a href="" ng-click="selectItem('registrarCambista', 'Precadastro de cambista')">
                        <i class="fa fa-link"></i> 
                        <span>Registrar Cambista</span>
                    </a>
                </li>
    ...
    <div class="content-wrapper">
        ...
        <!-- Main content -->
        <section class="content container-fluid" ng-switch="selection">

            <!-- Teste -->
            <div ng-switch-when="teste">
                Corpo do teste
            </div>
            <!-- /Teste -->
            ...
            <!-- Registra Cambista -->
            <div ng-switch-when="registrarCambista" ng-controller="cambistaCtrl">
                ...
                <div class="box box-info">
                    ...
                    <div class="center-600">
                        <div class="box-header with-border">
                            <h3 class="box-title">Cadastro de um novo cambista</h3>
                        </div>
                        <!-- /.box-header -->
                        ...
                        <!-- form start -->
                        <form name="cadastro" class="form-horizontal">
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <input validate-email name="email" ng-model="contato.email" type="text" class="form-control" id="inputEmail3" ng-required="true" placeholder="Digite um email aqui">
