                    ...
                    <div class="container-fluid">
                        <div class="row justify-content-between align-items-center">
                            ...
                            <div class="col col-xl-2">
                               <div class="logo">
                                    <a class="logo-header" href="<?php echo base_url() ?>" title="Return Home">
                                        <h2 style="color: red;padding-right: 5px;">
                                            Elite
                                        </h2>
                                        <h2>
                                            Sports
                ...
                <div class="container-fluid">
                   <div class="dark-home above">
                                ...
                                <ul class="nav nav-pills mb-3" id="main-tab" role="tablist">
                                    ...
                                    <!-- #nav-games-tab -->
                                    <li class="nav-item">
                                        <a class="nav-link active" id="nav-games-tab" data-toggle="pill" href="#nav-games" role="tab" aria-controls="nav-games" aria-selected="true">Jogos</a>
                                    </li>
                                    <!-- #nav-games-tab -->

                                    <!-- #nav-results-tab -->
                                    <li class="nav-item">
                                        <a class="nav-link" id="nav-results-tab" data-toggle="pill" href="#nav-results" role="tab" aria-controls="nav-results" aria-selected="false">Resultados</a>
                                    </li>
                                    <!-- #nav-results-tab -->
                                ...
                                <div class="tab-content" id="main-tab-content">
                                                        ...
                                                        <form action="#" method="post">
                                                            <div class="input-group">
                                                                ...
                                                                <span class="input-group-btn">
                                                                    <button class="btn btn-primary" type="submit" name="subscribe" >Buscar</button>
                                                                </span>
                                                            </div>
                                                        </form>
                                                    </div>
                                    ...
                                    <!-- #nav-livescore -->
                                    <div class="tab-pane fade" id="nav-livescore" role="tabpanel" aria-labelledby="nav-livescore-tab">    <div class="row">
                                        
                                            <div class="section-title single-result">
                                                <div class="container">
                                                    <div class="row">
                                                        <!-- Result Location -->
                                                        <div class="col-lg-12">
